    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user.addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() {
            ...
            public void onPropertyChanged(Observable sender, int propertyId) {
                if (propertyId == com.example.myapplication.BR.age) {
                    Log.d(TAG, "onPropertyChanged: " + "更新了age");
                } else if (propertyId == com.example.myapplication.BR.name) {
                    Log.d(TAG, "onPropertyChanged: " + "更新了name");
                } else if (propertyId == com.example.myapplication.BR.school) {
