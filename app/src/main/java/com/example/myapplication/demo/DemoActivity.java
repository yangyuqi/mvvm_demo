...
public class DemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        demoActivityViewModel.getImageBean().observe(this, new Observer<ImageBean>() {
            @Override
            public void onChanged(ImageBean imageBeanBaseData) {
                if (imageBeanBaseData.getImages() != null) {
                    //1.直接代码赋值
...
//                    activityDemoBinding.tvContent.setText(imageBeanBaseData.getData().getImages().get(0).getCopyright());
                    ...
                    activityDemoBinding.setImage(imageBeanBaseData.getImages().get(0));
                } else {
                    Toast.makeText(DemoActivity.this, "ssss", Toast.LENGTH_SHORT).show();
                }
